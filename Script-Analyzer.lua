...
-- Converted for Script-Ware by Compwnter#5640

if not getexecutorname then print("Exploit not supported") return end

local write = function(a) rconsoleprint(a, "white") end
local writei = function(a) rconsoleprint("[*]"..a, "blue") end
local writew = function(a) rconsoleprint("[*]"..a.."\n", "yellow") end
local writee = function(a) rconsoleprint(a, "red") end

rconsolecreate()
rconsolesettitle("Script Analyzer")
...
addcmd({"commands", "cmds"}, function(args)
 ...
 http - Analyze http requests made by the script.
